...
#> Staging 6 vintages ...
#> Calibrating 2016 against 2021 ...
#> Calibrating 2011 against 2021 ...
#> Calibrating 2006 against 2021 ...
#> Calibrating 2001 against 2021 ...
#> Calibrating 1996 against 2021 ...
#> Tolerances (m): 2021=40, 2016=10, 2011=40, 2006=40, 2001=40, 1996=39
#> Building the spine ...
#>   residual for 2016 ...
#>   residual for 2011 ...
#>   residual for 2006 ...
...
#>   coverage in 2001 ...
#>   coverage in 1996 ...
#> Writing tnet_calgary ...
#> Dropped 163 superseded pieces (4328 m).
#>   crosswalk for 2021 ...
#>   crosswalk for 2016 ...
#>   crosswalk for 2011 ...
#>   crosswalk for 2006 ...
#>   crosswalk for 2001 ...
#>   crosswalk for 1996 ...
#> Built 75,662 segments, 12,397 km.
...
#>  4    1996 spine           371
#>  5    2001 geometry+name 32478
#>  6    2001 geometry       9773
#>  7    2001 name_rescue    8971
#>  8    2001 spine           296
#>  9    2006 geometry+name 38877
...
``` r
base <- get_temporal_network("calgary") |>
  filter(list_contains(years, 2021L)) |>
  collect_road_network()

plot(sf::st_geometry(base), col = "grey85", lwd = 0.3,
     main = "Calgary CMA: road present in 2006, gone by 2021")
plot(sf::st_geometry(retired), col = "firebrick", lwd = 1.2, add = TRUE)
```
